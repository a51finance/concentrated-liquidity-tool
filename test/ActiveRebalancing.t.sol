...
contract ActiveRebalancingTest is Test, RebaseFixtures {
    ...
    function testCreateStrategyAR() public {
        ...
        // do a small swap
        executeSwap(token0, token1, owner, 100e18, 0, 0);
        executeSwap(token1, token0, owner, 100e18, 0, 0);
        executeSwap(token1, token0, owner, 400e18, 0, 0);
        executeSwap(token0, token1, owner, 150_000e18, 0, 0);

        _hevm.warp(block.timestamp + 3600);
        _hevm.roll(1 days);
        executeSwap(token0, token1, owner, 15_000e18, 0, 0);
        executeSwap(token1, token0, owner, 400e18, 0, 0);
        executeSwap(token0, token1, owner, 150_000e18, 0, 0);
    ...
    function testCreateStrategyARPartial() public {
        ...
        executeSwap(token0, token1, owner, 15_000e18, 0, 0);
        executeSwap(token1, token0, owner, 400e18, 0, 0);
        executeSwap(token0, token1, owner, 17_000e18, 0, 0);
    ...
    function test_Execute_Strategy_with_mode_1_against() public {
        ...
        executeSwap(token1, token0, owner, 100e18, 0, 0);
        executeSwap(token0, token1, owner, 100e18, 0, 0);
        executeSwap(token0, token1, owner, 400e18, 0, 0);
        executeSwap(token1, token0, owner, 15_000e18, 0, 0);
        executeSwap(token0, token1, owner, 400e18, 0, 0);
        executeSwap(token1, token0, owner, 17_000e18, 0, 0);
        _hevm.warp(block.timestamp + 3600);
        _hevm.roll(1 days);
    ...
    function test_Execute_Strategy_with_PP_AR_mode_1() public {
        ...
        executeSwap(token1, token0, owner, 400e18, 0, 0);
        executeSwap(token0, token1, owner, 17_000e18, 0, 0);
        executeSwap(token0, token1, owner, 100_000e18, 0, 0);
        _hevm.warp(block.timestamp + 3600);
        _hevm.roll(1 days);
    ...
    function test_Execute_Strategy_with_PP_AR_mode_2() public {
        ...
        executeSwap(token0, token1, owner, 400e18, 0, 0);
        executeSwap(token1, token0, owner, 17_000e18, 0, 0);
        executeSwap(token1, token0, owner, 100_000e18, 0, 0);
        _hevm.warp(block.timestamp + 3600);
        _hevm.roll(1 days);
    ...
    function test_Execute_Strategy_remaining_balance_check() public {
        ...
        executeSwap(token0, token1, owner, 400e18, 0, 0);
        executeSwap(token1, token0, owner, 17_000e18, 0, 0);
        executeSwap(token1, token0, owner, 65_000e18, 0, 0);
        _hevm.warp(block.timestamp + 3600);
        _hevm.roll(1 days);
    ...
    function testGetPreferenceTicksActive1() public {
        ...
        executeSwap(token1, token0, owner, 15_000e18, 0, 0);
        executeSwap(token0, token1, owner, 400e18, 0, 0);
        executeSwap(token1, token0, owner, 10_000e18, 0, 0);
        _hevm.warp(block.timestamp + 3600);
        _hevm.roll(1 days);
    ...
    function testGetPreferenceTicksActive2() public {
        ...
        executeSwap(token1, token0, owner, 100e18, 0, 0);
        executeSwap(token0, token1, owner, 220e18, 0, 0);
        ...
        executeSwap(token0, token1, owner, 400e18, 0, 0);
        executeSwap(token1, token0, owner, 10_000e18, 0, 0);
        executeSwap(token1, token0, owner, 175_000e18, 0, 0);
        _hevm.warp(block.timestamp + 3600);
        _hevm.roll(1 days);
    ...
    function testGetPreferenceTicksActive3() public {
        ...
        executeSwap(token1, token0, owner, 100e18, 0, 0);
        executeSwap(token0, token1, owner, 22e18, 0, 0);
    ...
    function initial() internal returns (ICLTBase.PositionActions memory positionActions) {
        ...
        executeSwap(token1, token0, owner, 200_000e18, 0, 0);
        executeSwap(token0, token1, owner, 85_000e18, 0, 0);
        executeSwap(token1, token0, owner, 95_000e18, 0, 0);
        _hevm.warp(block.timestamp + 3600);
        _hevm.roll(1 days);
    ...
    function testGetPreferenceTicksActive5() public {
        ...
        executeSwap(token1, token0, owner, 210_000e18, 0, 0);
        executeSwap(token0, token1, owner, 85_000e18, 0, 0);
        executeSwap(token1, token0, owner, 150_000e18, 0, 0);
        _hevm.warp(block.timestamp + 3600);
        _hevm.roll(1 days);
    ...
    function test_Execute_Strategy_with_mode_1_tick_calculation_2() public {
        ...
        executeSwap(token0, token1, owner, 15_000e18, 0, 0);
        executeSwap(token1, token0, owner, 400e18, 0, 0);
        executeSwap(token0, token1, owner, 170_000e18, 0, 0);
        _hevm.warp(block.timestamp + 3600);
        _hevm.roll(1 days);
        ...
        executeSwap(token0, token1, owner, 15_000e18, 0, 0);
        executeSwap(token1, token0, owner, 400e18, 0, 0);
        executeSwap(token0, token1, owner, 130_000e18, 0, 0);
        _hevm.warp(block.timestamp + 3600);
        _hevm.roll(1 days);
    ...
    function test_Execute_Strategy_with_mode_2_tick_calculation() public {
        ...
        executeSwap(token1, token0, owner, 15_000e18, 0, 0);
        executeSwap(token0, token1, owner, 400e18, 0, 0);
        executeSwap(token1, token0, owner, 35_000e18, 0, 0);
        _hevm.warp(block.timestamp + 3600);
        _hevm.roll(1 days);
    ...
    function test_Execute_Strategy_with_mode_3_Debug() public {
        ...
        executeSwap(token0, token1, owner, 15_000e18, 0, 0);
        executeSwap(token1, token0, owner, 400e18, 0, 0);
        executeSwap(token0, token1, owner, 300_000e18, 0, 0);
        _hevm.warp(block.timestamp + 3600);
        _hevm.roll(1 days);
