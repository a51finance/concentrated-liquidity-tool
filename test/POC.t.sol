...
contract POC is Test, UniswapDeployer {
    ...
    NonfungiblePositionManager(address(uniswapV3FactoryContract),address(weth),address(uniswapV3FactoryContract));
        ...
        baseContract =
            new CLTBase("ALP Base", "ALP", owner, address(weth),  address(feeHandler),uniswapV3FactoryContract);
    ...
    //     baseContract.createStrategy(strategyKey, positionActions, 0, 0, false, true);
    ...
    //     baseContract.createStrategy(strategyKey, positionActions, 0, 0, true, true);
