...
//         baseContract =
//         new CLTBase("ALP Base", "ALP", owner, address(0), address(feeHandler), address(cltModules),
...
//         (ICLTBase.StrategyKey memory key, address _owner,,, bool isCompound,,,,) =
// baseContract.strategies(strategyID);
...
//         (tl, tu) = rebaseModuleMockContract._getPreferenceTicks(strategyKey, _lowerPreferenceDiff,
// _upperPreferenceDiff);
